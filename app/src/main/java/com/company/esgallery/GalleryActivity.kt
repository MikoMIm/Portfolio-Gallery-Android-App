...
class GalleryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageInfoList = listOf(
            ImageInfo("01_valley_of_the_shadow_of_death", "Valley of the shadow of death\n", "Artist - Roger Fenton\n\nMedium: Salted paper print from glass negative\n\nDate - Made 1850s."),
            ImageInfo("02_lady_on_horseback", "Lady on horseback\n", "Artist - Roger Fenton\n\nMedium: Salted paper print from glass negative\n\nDate - Made 1850s."),
            ImageInfo("03_Newcastle_on_Tyne", "Newcastle on Tyne\n", "Artist - Roger Fenton\n\nMedium: Albumen silver print from glass negative.\n\nDate - 1850s."),
            ImageInfo("04_landscape_with_clouds", "Landscape with clouds\n", "Artist - Roger Fenton\n\n Medium: Salted paper print from glass negative \n\nDate -  probably 1856"),
            ImageInfo("05_Wharfe_and_Pool", "Wharfe and Pool\n", "Artist - Roger Fenton\n\nMedium: Salted paper print\n\nDate - Made 1854"),
            ImageInfo("06_Landing_Place", "Landing Place\n", "Artist - Roger Fenton\n\n Medium: Salted paper print from glass negative\n\nDate - Made  1855"),
            ImageInfo("07_The_Refectory_of_the_Imperial_Asylum_at_Vincennes", "The Refectory of the Imperial Asylum at Vincennes\n", "Artist - Roger Fenton\n\n Medium: Salted paper print from glass negative \n\nDate - Made 1858–59")
